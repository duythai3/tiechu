...
// initialize
gboolean teochew_table_init(){
	//
	_char_expand_table_init();
    logger_log("teochew table opened");
	return TRUE;
}

// destroy
void teochew_table_destroy(){
	//
	_char_expand_table_destroy();
    logger_log("teochew table destroyed");
}

gboolean teochew_table_find(){
	//
...
// increase frequency
void teochew_table_increase_frequency(const gchar *chinese_char){
	//
