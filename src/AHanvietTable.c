...
// initialize
gboolean a_hanviet_table_init(){
	//
	_char_expand_table_init();
    a_logger_log("hanviet table opened");
	return TRUE;
}

// destroy
void a_hanviet_table_destroy(){
	//
	_char_expand_table_destroy();
    a_logger_log("hanviet table destroyed");
}

gboolean a_hanviet_table_find(){
	//
...
// increase frequency
void a_hanviet_table_increase_frequency(const gchar *chinese_char){
	//
