 ...
 *
 * Copyright (c) 2020-2022 Duy Thai,duythaiz234@yahoo.com
 *
 ...
 */
const gchar * a_ltelex_table_convert_to_pinyin(const gchar* ascii_clutter){
    glong written = 0;
