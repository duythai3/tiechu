...
void a_property_list_update_symbol(IBusAbacusEngine* abacus) {
	...
	update_symbol(prop);
	ibus_engine_update_property((IBusEngine*)abacus, prop);
}
...
void a_property_list_destroy(){
	//
	if (!_property_list) {
        a_logger_warn("Property list was not initialized");
		return;
	}
...
void a_property_list_register(IBusAbacusEngine* abacus){
    ...
    //
	ibus_engine_register_properties((IBusEngine*)abacus, _property_list);
}

void a_property_list_update(IBusAbacusEngine* abacus){
    IBusProperty *prop;
    IBusEngine *engine = (IBusEngine*)abacus;
	...
	//
    a_property_list_update_symbol(abacus);
